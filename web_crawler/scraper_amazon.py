...
_CSS_SELECTORS_DESKTOP = {
    "product": "#s-results-list-atf",
    "title": "a.s-access-detail-page > h2",
    "price_currency": "a-link-normal > a-color-base > sx-price-large > sx-price-currency",
    "price_whole" : "sx-price-whole",
    "price_fraction" : "sx-price-fraction",
